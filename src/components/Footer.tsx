      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid md:grid-cols-3 gap-8 items-start">
          ...
          <div className="flex gap-3 justify-start md:justify-end">
            {socials.map((s, i) => (
              <motion.a key={i} href={s.href} target="_blank" rel="noreferrer" whileHover={{ scale: 1.15, y: -2 }} className="w-10 h-10 rounded-lg bg-white/5 flex items-center justify-center text-gray-400 hover:text-[#64ffda] hover:bg-[#64ffda]/10 transition-all cursor-pointer" aria-label={s.label}><s.icon size={18} /></motion.a>
            ))}
          </div>
        </div>
